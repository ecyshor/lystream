...
function X2JS(a, b, c) {
    ...
    var s = "1.0.11", t = !1, u = {ELEMENT_NODE: 1, TEXT_NODE: 3, CDATA_SECTION_NODE: 4, COMMENT_NODE: 8, DOCUMENT_NODE: 9};
...
if (function (a) {
    ...
    b.System = function () {
    ...
    }, b.System.prototype = {_createAndSetupInstance: function (a, b) {
        var c = new b;
        ...
        return this._mappings[a] = {clazz: null, object: b, isSingleton: !0}, this.autoMapOutlets && this.mapOutlet(a), this.hasMapping(a) && this.injectInto(b, a), this
        ...
        return this._mappings[a] = {clazz: b, object: null, isSingleton: !1}, this.autoMapOutlets && this.mapOutlet(a), this
    }, mapSingleton: function (a, b) {
        if ("undefined" == typeof a)throw new Error(1060);
        if ("undefined" == typeof b)throw new Error(1061);
        return this._mappings[a] = {clazz: b, object: null, isSingleton: !0}, this.autoMapOutlets && this.mapOutlet(a), this
        ...
        return b = b || "global", c = c || a, "undefined" == typeof d && (d = !1), "undefined" == typeof e && (e = !1), this._handlers.hasOwnProperty(a) || (this._handlers[a] = {}), this._handlers[a].hasOwnProperty(b) || (this._handlers[a][b] = []), this._handlers[a][b].push({handler: c, oneShot: d, passEvent: e}), this
...
MediaPlayer = function (a) {
    "use strict";
    var b, c, d, e, f, g = "1.1.2", h = a, i = !1, j = !1, k = !0, l = !1, m = MediaPlayer.dependencies.BufferExtensions.BUFFER_SIZE_REQUIRED, n = function () {
        return!!c && !!d
    }, o = function () {
    ...
    return b = new dijon.System, b.mapValue("system", b), b.mapOutlet("system"), b.injectInto(h), {debug: void 0, eventBus: void 0, capabilities: void 0, abrController: void 0, metricsModel: void 0, metricsExt: void 0, bufferExt: void 0, addEventListener: function (a, b, c) {
    ...
    "use strict";
    return{system: void 0, setup: function () {
    ...
    var a = function (a, b) {
        ...
        for (n.version = m.getUint8(o + 8), o += 12, n.timescale = m.getUint32(o + 4, !1), o += 8, 0 === n.version ? (n.earliest_presentation_time = m.getUint32(o, !1), n.first_offset = m.getUint32(o + 4, !1), o += 8) : (n.earliest_presentation_time = utils.Math.to64BitNumber(m.getUint32(o + 4, !1), m.getUint32(o, !1)), n.first_offset = (m.getUint32(o + 8, !1) << 32) + m.getUint32(o + 12, !1), o += 16), n.first_offset += e + (b || 0), n.reference_count = m.getUint16(o + 2, !1), o += 4, n.references = [], c = n.first_offset, d = n.earliest_presentation_time, f = 0; f < n.reference_count; f += 1)h = m.getUint32(o, !1), g = h >>> 31, h = 2147483647 & h, i = m.getUint32(o + 4, !1), o += 12, n.references.push({size: h, type: g, offset: c, duration: i, time: d, timescale: n.timescale}), c += h, d += i;
        ...
        var d, e, f, g, h, i, j, k = Q.defer(), l = new DataView(a), m = 0, n = "", o = 0, p = !1, q = this;
        for (q.debug.log("Searching for initialization."); "moov" !== n && m < l.byteLength;) {
        ...
        var b = Q.defer(), d = new XMLHttpRequest, e = !0, f = this, g = {url: a, range: {}, searching: !1, bytesLoaded: 0, bytesToLoad: 1500, request: d};
        ...
        var d, f = Q.defer(), g = new XMLHttpRequest, h = !0, i = this, j = {url: a, range: {}, searching: !1, bytesLoaded: 0, bytesToLoad: 1500, request: g};
    ...
    return{debug: void 0, errHandler: void 0, loadSegments: f, loadInitialization: d, parseSegments: b, parseSIDX: a, findSIDX: e}
    ...
    var a, b, c, d = -1, e = function (a, b) {
        ...
        var c, e, f, g = a.adaptation.period, h = !1;
        ...
        var c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = this, s = b.adaptation.period.mpd.manifest.Period_asArray[b.adaptation.period.index].AdaptationSet_asArray[b.adaptation.index].Representation_asArray[b.index].SegmentTemplate, u = s.SegmentTimeline, v = b.availableSegmentsNumber > 0, w = 10, x = [], y = 0, z = -1, A = function (a) {
            return t.call(q, b, y, a.d, p, s.media, a.mediaRange, z)
        };
        for (p = b.timescale, c = u.S_asArray, k = r.call(q, b), k ? (n = k.start, o = k.end) : m = q.timelineConverter.calcMediaTimeFromPresentationTime(a || 0, b), e = 0, f = c.length; f > e; e += 1)if (d = c[e], h = 0, d.hasOwnProperty("r") && (h = d.r), d.hasOwnProperty("t") && (y = d.t), 0 > h && (j = c[e + 1], i = j && j.hasOwnProperty("t") ? j.t / p : b.adaptation.period.duration, h = Math.ceil((i - y / p) / (d.d / p)) - 1), l) {
            if (v)break;
            z += h + 1
        ...
        return b.segmentAvailabilityRange = {start: x[0].presentationStartTime, end: x[x.length - 1].presentationStartTime}, v || (b.availableSegmentsNumber = z), Q.when(x)
    }, p = function (a) {
        var b, c, d, g, h = [], i = this, j = Q.defer(), k = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[a.index].SegmentTemplate, l = a.segmentDuration, m = null, o = null, p = null;
        ...
        var e, f, g, h = c.segmentDuration, i = c.adaptation.period.mpd.manifest.minBufferTime, j = c.segmentAvailabilityRange, k = 0 / 0, l = null, m = c.segments, n = 2 * h, o = Math.max(2 * i, 10 * h);
        return b && !c.adaptation.period.isClientServerTimeSyncCompleted ? (e = Math.floor(j.start / h), f = Math.floor(j.end / h), g = {start: e, end: f}) : (m ? (l = y(d, c), k = l ? l.presentationStartTime : d > 0 ? d * h : a || m[0].presentationStartTime) : k = d > 0 ? d * h : b ? j.end : j.start, e = Math.floor(Math.max(k - n, j.start) / h), f = Math.floor(Math.min(k + o, j.end) / h), g = {start: e, end: f})
    }, r = function (a) {
        var c, e, f, g = 0 / 0, h = a.segments, i = 2, j = 10, k = 0, l = Number.POSITIVE_INFINITY;
        if (b && !a.adaptation.period.isClientServerTimeSyncCompleted)return f = {start: k, end: l};
        if (h) {
            if (0 > d)return null;
            g = d
        } else g = d > 0 ? d : b ? l : k;
        return c = Math.max(g - i, k), e = Math.min(g + j, l), f = {start: c, end: e}
    }, s = function (a) {
        ...
        var l, m, n, o = this, p = c / g, q = Math.min(d / g, a.adaptation.period.mpd.maxSegmentDuration);
        ...
        var b, c, d, e, f, g, h, i = this, j = [], k = Q.defer(), l = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[a.index].SegmentList, m = l.SegmentURL_asArray.length;
        ...
        return a.indexRange && (k = a.indexRange), this.baseURLExt.loadSegments(g, k).then(function (g) {
            ...
            a.segmentAvailabilityRange = {start: i[0].presentationStartTime, end: i[d - 1].presentationStartTime}, a.availableSegmentsNumber = d, h.resolve(i)
        }), h.promise
    }, w = function (a) {
        ...
        var c, d, e, f, g = b.segments, h = g.length - 1, i = -1;
        ...
        var b, d = new MediaPlayer.vo.SegmentRequest, i = a.representation, k = i.adaptation.period.mpd.manifest.Period_asArray[i.adaptation.period.index].AdaptationSet_asArray[i.adaptation.index].Representation_asArray[i.index].bandwidth;
    ...
    return{debug: void 0, baseURLExt: void 0, manifestModel: void 0, manifestExt: void 0, errHandler: void 0, timelineConverter: void 0, getType: function () {
        return c
    }, setType: function (a) {
        c = a
        ...
        b = a
    }, getInitRequest: l, getSegmentRequestForTime: B, getNextSegmentRequest: C, getCurrentTime: E, getSegmentCountForDuration: D}
...
}, Dash.dependencies.DashManifestExtensions.prototype = {constructor: Dash.dependencies.DashManifestExtensions, getIsAudio: function (a) {
    "use strict";
    ...
    if (a.hasOwnProperty("mimeType") && (f = -1 !== a.mimeType.indexOf("text"), g = !0), !g)for (b = 0, c = a.Representation_asArray.length; !g && c > b;)d = a.Representation_asArray[b], d.hasOwnProperty("mimeType") && (f = -1 !== d.mimeType.indexOf("text"), g = !0), b += 1;
    return Q.when(f)
    ...
    "use strict";
    var c, d, e = this, f = a.Period_asArray[b].AdaptationSet_asArray, g = Q.defer(), h = [];
    ...
    return{manifestModel: void 0, manifestExt: void 0, getBandwidthForRepresentation: e, getIndexForRepresentation: f, getMaxIndexForBufferType: g, getCurrentRepresentationSwitch: h, getCurrentBufferLevel: i, getCurrentHttpRequest: j, getHttpRequests: k, getCurrentDroppedFrames: l}
    ...
    var a = function (a) {
        ...
        return c = i.getUint8(j), this.debug.log("position: " + j), 0 === c ? (j += 4, b = i.getUint32(j, !1)) : (j += d - 16, b = utils.Math.to64BitNumber(i.getUint32(j + 4, !1), i.getUint32(j, !1))), h.resolve({version: c, base_media_decode_time: b}), h.promise
    }, b = function (a) {
        ...
        return b = i.getUint8(j + 8), j += 12, c = i.getUint32(j + 4, !1), j += 8, d = 0 === b ? i.getUint32(j, !1) : utils.Math.to64BitNumber(i.getUint32(j + 4, !1), i.getUint32(j, !1)), Q.when({earliestPresentationTime: d, timescale: c})
    }, c = function (b) {
...
}, Dash.dependencies.FragmentExtensions.prototype = {constructor: Dash.dependencies.FragmentExtensions}, Dash.dependencies.TimelineConverter = function () {
    "use strict";
    var a = function (a, b, c, d) {
        ...
        var c, d, f = 1e3 * a.adaptation.period.clientServerTimeShift, g = a.segmentDuration, h = 0, i = a.adaptation.period.duration, j = {start: h, end: i};
        ...
        var b = a.adaptation.period.start, c = a.presentationTimeOffset;
        return b - c
    };
    return{system: void 0, debug: void 0, setup: function () {
        this.system.mapHandler("liveEdgeFound", void 0, j.bind(this))
    }, calcAvailabilityStartTimeFromPresentationTime: b, calcAvailabilityEndTimeFromPresentationTime: c, calcPresentationTimeFromWallTime: e, calcPresentationTimeFromMediaTime: f, calcPresentationStartTime: d, calcMediaTimeFromPresentationTime: g, calcSegmentAvailabilityRange: i, calcWallTimeForSegment: h, calcMSETimeOffset: k}
...
}, Dash.vo.AdaptationSet.prototype = {constructor: Dash.vo.AdaptationSet}, Dash.vo.Mpd = function () {
    "use strict";
    ...
    return{debug: void 0, abrRulesCollection: void 0, manifestExt: void 0, metricsModel: void 0, getAutoSwitchBitrate: function () {
        return a
            ...
            n.abrRulesCollection.getRules().then(function (d) {
                ...
                Q.all(r).then(function (a) {
                    ...
                    k[MediaPlayer.rules.SwitchRequest.prototype.WEAK] !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && (q = MediaPlayer.rules.SwitchRequest.prototype.WEAK, p = k[MediaPlayer.rules.SwitchRequest.prototype.WEAK]), k[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT] !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && (q = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT, p = k[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT]), k[MediaPlayer.rules.SwitchRequest.prototype.STRONG] !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && (q = MediaPlayer.rules.SwitchRequest.prototype.STRONG, p = k[MediaPlayer.rules.SwitchRequest.prototype.STRONG]), p !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && void 0 !== p && (l = p), q !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && void 0 !== q && (m = q), n.manifestExt.getRepresentationCount(c).then(function (a) {
                        0 > l && (l = 0), l >= a && (l = a - 1), m != MediaPlayer.rules.SwitchRequest.prototype.STRONG && m != MediaPlayer.rules.SwitchRequest.prototype.WEAK && (m = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT), e(b, l), g(b, m), o.resolve({quality: l, confidence: m})
                    })
                })
            })
    ...
    "use strict";
    var a, b, c, d, e, f, g, h = .5, i = 22, j = "WAITING", k = "READY", l = "VALIDATING", m = "LOADING", n = j, o = !1, p = !1, q = !1, r = !0, s = [], t = !1, u = -1, v = !0, w = -1, x = !1, y = !1, z = !1, A = [], B = null, C = Q.defer(), D = null, E = null, F = null, G = 0, H = null, I = 0, J = !1, K = null, L = 0, M = !1, N = null, O = null, P = null, R = !1, S = null, T = null, U = null, V = null, W = !0, X = function (a) {
        var b = this;
        ...
        if (this.fragmentController.isInitializationRequest(a))X.call(this, k); else {
            X.call(this, m);
        ...
        var d = this, e = a == K, g = e ? D : Q.defer(), h = e ? A.length : A.push(g), k = d.videoModel.getCurrentTime(), l = new Date;
        ...
        var a = this, b = Q.defer(), c = Ab.call(a);
        ...
        var a = this.bufferExt.getLeastBufferLevel(), b = 2 * L, c = I - a;
        ...
        return O = c.end, N = {start: Math.max(0, O - d), end: O + d}, P = Math.floor((c.end - c.start) / 2), a.indexHandler.getSegmentRequestForTime(b, O).then(pb.bind(a, O, rb, qb)), e = Q.defer(), e.promise
    }, pb = function (a, c, d, e) {
        var f = this;
        null === e ? (b.segments = null, b.segmentAvailabilityRange = {start: a - P, end: a + P}, f.indexHandler.getSegmentRequestForTime(b, a).then(pb.bind(f, a, c, d))) : f.fragmentController.isFragmentExists(e).then(function (b) {
        ...
        if (v && !t)d.debug.log("Data changed - loading the " + f + " fragment for time: " + c), a = d.indexHandler.getSegmentRequestForTime(b, c); else {
            var e = Q.defer(), g = d.videoModel.getCurrentTime();
        ...
        var a = this, c = a.videoModel.getPlaybackRate(), d = I / Math.max(c, 1), e = Q.defer();
        ...
        if (n === m && h > I)x || (c.debug.log("Stalling " + f + " Buffer: " + f), Y(new Date, MediaPlayer.vo.metrics.PlayList.Trace.REBUFFERING_REASON), x = !0, q = !0, c.videoModel.stallStream(f, x)); else if (n === k) {
            X.call(c, l);
    ...
    return{videoModel: void 0, metricsModel: void 0, manifestExt: void 0, manifestModel: void 0, bufferExt: void 0, sourceBufferExt: void 0, abrController: void 0, fragmentExt: void 0, indexHandler: void 0, debug: void 0, system: void 0, errHandler: void 0, scheduleWhilePaused: void 0, initialize: function (a, c, d, e, f, h, i, j) {
        var k = this, l = k.manifestModel.getValue();
    ...
    return{system: void 0, videoModel: void 0, manifestExt: void 0, metricsExt: void 0, metricsModel: void 0, abrController: void 0, bufferMax: void 0, updateData: function (a, b) {
        ...
        var i, j = this, k = j.metricsModel.getReadOnlyMetricsFor("video"), l = j.metricsModel.getReadOnlyMetricsFor("audio"), m = f >= MediaPlayer.dependencies.BufferExtensions.LONG_FORM_CONTENT_DURATION_THRESHOLD, n = Q.defer(), o = null;
    ...
    "use strict"
}, MediaPlayer.utils.Capabilities.prototype = {constructor: MediaPlayer.utils.Capabilities, supportsMediaSource: function () {
    "use strict";
    ...
    "use strict";
    var a = !0;
    return{eventBus: void 0, setLogToBrowserConsole: function (b) {
        a = b
    ...
    "use strict";
    return{eventBus: void 0, capabilityError: function (a) {
        ...
        this.eventBus.dispatchEvent({type: "error", error: "manifestError", event: {message: a, id: b, manifest: c}})
    ...
    return c(), {addEventListener: function (a, c, d) {
    ...
    return{system: void 0, debug: void 0, fragmentLoader: void 0, process: function (a) {
        var b = null;
    ...
    return{metricsModel: void 0, errHandler: void 0, debug: void 0, load: function (b) {
    ...
    return{system: void 0, debug: void 0, fragmentLoader: void 0, setContext: function (b) {
        a = b
    }, getContext: function () {
        return a
...
}, MediaPlayer.dependencies.FragmentModel.prototype = {constructor: MediaPlayer.dependencies.FragmentModel}, MediaPlayer.dependencies.ManifestLoader = function () {
    "use strict";
    ...
    return{debug: void 0, parser: void 0, errHandler: void 0, metricsModel: void 0, load: function (b) {
    ...
    "use strict";
    var a;
    return{system: void 0, eventBus: void 0, getValue: function () {
        return a
    }, setValue: function (b) {
    ...
    var a, b = 0 / 0, c = null, d = function () {
        ...
        var a = this, c = a.manifestModel.getValue();
    ...
    return{debug: void 0, system: void 0, manifestModel: void 0, manifestExt: void 0, manifestLoader: void 0, setup: function () {
    ...
    "use strict"
}, MediaPlayer.dependencies.MediaSourceExtensions.prototype = {constructor: MediaPlayer.dependencies.MediaSourceExtensions, createMediaSource: function () {
    "use strict";
    var a = "WebKitMediaSource"in window, b = "MediaSource"in window;
    ...
    "use strict";
    return{system: void 0, eventBus: void 0, streamMetrics: {}, metricsChanged: function () {
        ...
        this.eventBus.dispatchEvent({type: "metricUpdated", data: {stream: a, metric: b, value: c}}), this.metricChanged(a)
    }, metricAdded: function (a, b, c) {
        this.eventBus.dispatchEvent({type: "metricAdded", data: {stream: a, metric: b, value: c}}), this.metricChanged(a)
...
}, MediaPlayer.models.MetricsModel.prototype = {constructor: MediaPlayer.models.MetricsModel}, MediaPlayer.dependencies.ProtectionController = function () {
    "use strict";
    ...
    return{system: void 0, debug: void 0, manifestExt: void 0, capabilities: void 0, videoModel: void 0, protectionModel: void 0, protectionExt: void 0, setup: function () {
        b = this.protectionExt.getKeySystems()
    }, init: function (b, c) {
        this.videoModel = b, this.protectionModel = c, a = this.videoModel.getElement()
    }, selectKeySystem: d, ensureKeySession: e, updateFromMessage: f, teardownKeySystem: c}
    ...
    "use strict"
}, MediaPlayer.dependencies.ProtectionExtensions.prototype = {constructor: MediaPlayer.dependencies.ProtectionExtensions, supportsCodec: function (a, b) {
    "use strict";
    ...
    var a = function (a, b) {
        ...
        for (var k = 0; k < i.length; k++)e[k] = {name: i[k].childNodes[0].nodeValue, value: j[k].childNodes[0].nodeValue};
    ...
    return[
        {schemeIdUri: "urn:uuid:9a04f079-9840-4286-ab92-e65be0885f95", keysTypeString: "com.microsoft.playready", isSupported: function (a) {
            return this.schemeIdUri === a.schemeIdUri.toLowerCase()
        }, needToAddKeySession: b, getInitData: c, getUpdate: a},
        {schemeIdUri: "urn:mpeg:dash:mp4protection:2011", keysTypeString: "com.microsoft.playready", isSupported: function (a) {
            return this.schemeIdUri === a.schemeIdUri.toLowerCase() && "cenc" === a.value.toLowerCase()
        }, needToAddKeySession: b, getInitData: function () {
            return null
        }, getUpdate: a},
        {schemeIdUri: "urn:uuid:00000000-0000-0000-0000-000000000000", keysTypeString: "webkit-org.w3.clearkey", isSupported: function (a) {
            return this.schemeIdUri === a.schemeIdUri.toLowerCase()
    ...
    return{system: void 0, videoModel: void 0, protectionExt: void 0, setup: function () {
        ...
        var f = null;
        f = this.protectionExt.createMediaKeys(d.keysTypeString), this.protectionExt.setMediaKey(a, f), e[b] = {kID: b, contentProtection: c, keySystem: d, keys: f, initData: null, keySessions: []}
    ...
    return{system: void 0, videoModel: void 0, debug: void 0, schedulerExt: void 0, isScheduled: function (a) {
        var b = z(a, e);
    ...
    }, startScheduling: q, stopScheduling: u, setTriggerForVideoTime: h, setTriggerForWallTime: o, removeTriggerForVideoTime: k, removeTriggerForWallTime: p}
}, MediaPlayer.dependencies.RequestScheduler.prototype = {constructor: MediaPlayer.dependencies.RequestScheduler}, MediaPlayer.dependencies.SchedulerExtensions = function () {
    "use strict"
}, MediaPlayer.dependencies.SchedulerExtensions.prototype = {constructor: MediaPlayer.dependencies.SchedulerExtensions, getExecuteInterval: function (a) {
    var b = 1e3;
    ...
    "use strict";
    var a, b, c, d, e, f = !1;
    return{system: void 0, debug: void 0, schedulerExt: void 0, setContext: function (b) {
        a = b
    }, getContext: function () {
        return a
...
}, MediaPlayer.dependencies.SourceBufferExtensions.prototype = {constructor: MediaPlayer.dependencies.SourceBufferExtensions, createSourceBuffer: function (a, b) {
    "use strict";
    ...
    "use strict";
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = null, r = null, s = null, t = null, u = -1, v = null, w = -1, x = null, y = -1, z = !0, A = !1, B = !1, C = null, D = [], E = null, F = function () {
        ...
        var b, c = this;
        if (b = "msneedkey" !== a.type ? a.type : q, D.push({type: b, initData: a.initData}), this.debug.log("DRM: Key required for - " + b), s && q && !C)try {
        ...
        var c, d, e, f, g, h, i = this, j = Q.defer(), k = Q.defer(), l = Q.defer();
    ...
    return{system: void 0, videoModel: void 0, manifestLoader: void 0, manifestModel: void 0, mediaSourceExt: void 0, sourceBufferExt: void 0, bufferExt: void 0, manifestExt: void 0, fragmentController: void 0, abrController: void 0, fragmentExt: void 0, protectionModel: void 0, protectionController: void 0, protectionExt: void 0, capabilities: void 0, debug: void 0, metricsExt: void 0, errHandler: void 0, timelineConverter: void 0, requestScheduler: void 0, scheduleWhilePaused: void 0, setup: function () {
        ...
        return E
    }, updateData: gb, play: F, seek: H, pause: G}
    ...
    "use strict";
    var a, b, c, d, e = [], f = 4, g = 3, h = !0, i = !1, j = function () {
        a.play()
    }, k = function () {
        a.pause()
    }, l = function (b) {
        ...
        if (b.length) {
            var c = b.length - 1, e = b.end(c), g = a.getStartTime() + a.getDuration() - e;
        ...
        var b = a.getVideoModel().getCurrentTime(), c = v(b);
        ...
        var b = 0, c = null, d = e.length;
        d > 0 && (b += e[0].getStartTime());
        for (var f = 0; d > f; f++)if (c = e[f], b += c.getDuration(), b > a)return c
    }, w = function () {
        ...
        var b, c, d, f, g, i, j = this, k = j.manifestModel.getValue(), l = Q.defer(), m = [];
    ...
    return{system: void 0, videoModel: void 0, manifestLoader: void 0, manifestUpdater: void 0, manifestModel: void 0, mediaSourceExt: void 0, sourceBufferExt: void 0, bufferExt: void 0, manifestExt: void 0, fragmentController: void 0, abrController: void 0, fragmentExt: void 0, capabilities: void 0, debug: void 0, metricsModel: void 0, videoExt: void 0, errHandler: void 0, setup: function () {
    ...
    }, play: j, seek: l, pause: k}
}, MediaPlayer.dependencies.StreamController.prototype = {constructor: MediaPlayer.dependencies.StreamController}, MediaPlayer.models.VideoModel = function () {
    "use strict";
    var a, b = [], c = function () {
        return b.length > 0
    }, d = function (c) {
    ...
    "use strict";
    return{getPlaybackQuality: function (a) {
        var b = "webkitDroppedFrameCount"in a, c = "getVideoPlaybackQuality"in a, d = null;
        return c ? d = a.getVideoPlaybackQuality() : b && (d = {droppedVideoFrames: a.webkitDroppedFrameCount, creationTime: new Date}), d
    }}
}, MediaPlayer.dependencies.VideoModelExtensions.prototype = {constructor: MediaPlayer.dependencies.VideoModelExtensions}, MediaPlayer.dependencies.TextController = function () {
    var a, b, c, d = "LOADING", e = "READY", f = !1, g = null, h = e, i = function (a) {
    ...
    return{videoModel: void 0, fragmentLoader: void 0, fragmentController: void 0, indexHandler: void 0, sourceBufferExt: void 0, manifestModel: void 0, manifestExt: void 0, debug: void 0, initialize: function (a, b, c, d) {
        var e = this;
...
}, MediaPlayer.dependencies.TextController.prototype = {constructor: MediaPlayer.dependencies.TextController}, MediaPlayer.utils.TextTrackExtensions = function () {
    "use strict";
    return{addTextTrack: function (a, b, c, d, e) {
    ...
    var a, b, c;
    return{system: void 0, eventBus: void 0, initialize: function (d, e) {
...
},MediaPlayer.dependencies.TextVTTSourceBuffer.prototype = {constructor: MediaPlayer.dependencies.TextVTTSourceBuffer},MediaPlayer.utils.VTTParser = function () {
    "use strict";
    var a = function (a) {
    ...
    "use strict";
    var a = [];
    return{downloadRatioRule: void 0, insufficientBufferRule: void 0, getRules: function () {
        return Q.when(a)
    }, setup: function () {
        var a = this;
    ...
    return{debug: void 0, manifestExt: void 0, metricsExt: void 0, checkIndex: function (b, c, d) {
    ...
    "use strict";
    var a = 0, b = 3;
    return{debug: void 0, checkIndex: function (c, d) {
    ...
    return{debug: void 0, checkIndex: function (e, f) {
...
},MediaPlayer.rules.LimitSwitchesRule.prototype = {constructor: MediaPlayer.rules.LimitSwitchesRule},MediaPlayer.rules.SwitchRequest = function (a, b) {
    "use strict";
    this.quality = a, this.priority = b, void 0 === this.quality && (this.quality = 999), void 0 === this.priority && (this.priority = .5)
},MediaPlayer.rules.SwitchRequest.prototype = {constructor: MediaPlayer.rules.SwitchRequest, NO_CHANGE: 999, DEFAULT: .5, STRONG: 1, WEAK: 0},MediaPlayer.models.MetricsList = function () {
    "use strict";
    return{TcpList: [], HttpList: [], RepSwitchList: [], BufferLevel: [], PlayList: [], DroppedFrames: []}
...
},MediaPlayer.vo.SegmentRequest.prototype = {constructor: MediaPlayer.vo.SegmentRequest, ACTION_DOWNLOAD: "download", ACTION_COMPLETE: "complete"},MediaPlayer.vo.metrics.BufferLevel = function () {
    "use strict";
    this.t = null, this.level = null
},MediaPlayer.vo.metrics.BufferLevel.prototype = {constructor: MediaPlayer.vo.metrics.BufferLevel},MediaPlayer.vo.metrics.DroppedFrames = function () {
    "use strict";
...
},MediaPlayer.vo.metrics.HTTPRequest.Trace.prototype = {constructor: MediaPlayer.vo.metrics.HTTPRequest.Trace},MediaPlayer.vo.metrics.PlayList = function () {
    "use strict";
...
},MediaPlayer.vo.metrics.RepresentationSwitch.prototype = {constructor: MediaPlayer.vo.metrics.RepresentationSwitch},MediaPlayer.vo.metrics.TCPConnection = function () {
    "use strict";
